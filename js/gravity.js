...
function init() {
  ...
  worldAABB.maxVertex.Set(window.innerWidth + 200, window.innerHeight - bottomMargin + 200);
...
function getBrowserDimensions() {
  ...
  if (stage[3] != window.innerHeight - bottomMargin) {
    stage[3] = window.innerHeight - bottomMargin;
    changed = true;
  }
